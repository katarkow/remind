...
*** cm_implicitQttyTarget - Define quantity target for primary, secondary, final energy or CCS (PE, SE and FE in TWa, or CCS and DAC in Mt CO2) per target group (total, biomass, fossil, VRE, renewables, synthetic, ...).
