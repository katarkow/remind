...
$ifthen.cm_implicitQttyTarget not "%cm_implicitQttyTarget%" == "off"
  ...
  pm_implicitQttyTarget(ttot,ext_regi,taxType,targetType,"dac",qttyTargetGroup)$pm_implicitQttyTarget(ttot,ext_regi,taxType,targetType,"dac",qttyTargetGroup) = pm_implicitQttyTarget(ttot,ext_regi,taxType,targetType,"dac",qttyTargetGroup)/(sm_c_2_co2*1000);
