...
*** Implicit tax/subsidy necessary to achieve quantity target for primary, secondary, final energy and/or CCS and/or DAC
...
qttyTarget "quantity target for energy carrier level (primary, secondary, final energy) or CCS or DAC"
/
  PE              "Primary Energy"
  SE              "Secondary Energy"
  FE              "Final Energy"
